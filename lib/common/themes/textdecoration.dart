...
var textFieldWithBorder = InputDecoration(
  fillColor: Colors.white,
  filled: true,
  border: OutlineInputBorder(
    borderRadius: BorderRadius.circular(5),
    borderSide: const BorderSide(width: 0.5, color: dividerColor),
  ),
  enabledBorder: OutlineInputBorder(
    borderRadius: BorderRadius.circular(5),
    borderSide: const BorderSide(width: 0.5, color: dividerColor),
  ...
  counterStyle: const TextStyle(fontSize: 12, height: 0.5),
  errorMaxLines: 3,
  errorStyle: const TextStyle(fontSize: 11, color: mandatoryStarColor),
